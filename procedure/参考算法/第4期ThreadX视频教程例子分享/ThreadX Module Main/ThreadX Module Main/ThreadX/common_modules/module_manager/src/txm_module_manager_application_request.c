...
/*                                                                        */
/**************************************************************************/
extern UINT  ModuleManagerAppRequest(ULONG request_id, ALIGN_TYPE param_1, ALIGN_TYPE param_2, ALIGN_TYPE param_3);
UINT  _txm_module_manager_application_request(ULONG request_id, ALIGN_TYPE param_1, ALIGN_TYPE param_2, ALIGN_TYPE param_3)
{
    UINT ret;
    
    ret = ModuleManagerAppRequest(request_id, param_1, param_2, param_3);
