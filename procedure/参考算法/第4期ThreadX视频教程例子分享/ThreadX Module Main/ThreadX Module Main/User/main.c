...
*                2. 发送串口字符"1" :加载APP1,  地址0x08020000。
*                   发送串口字符"2" :卸载APP1,  地址0x08020000。 
*                   发送串口字符"3" :加载APP2,  地址0x08040000。 
*                   发送串口字符"4" :卸载APP2,  地址0x08040000。 
*                   发送串口字符"5" :打印任务执行情况。 
...
*	修改记录 :
*		版本号   日期         作者            说明
*       V1.0    2022-04-30   Eric2013    1. ST固件库1.9.0版本
*                                        2. BSP驱动包V1.2
*                                        3. ThreadX版本V6.1.10
*                                       
...
*********************************************************************************************************
*/
extern void module_application_define(void);
static  void  AppTaskStart (ULONG thread_input)
{
